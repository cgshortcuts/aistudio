...
function createWindow(): BrowserWindow {
  ...
  if (isElectronDevMode()) {
    window.loadURL(
      // === CUSTOM FORK START: AiStudio Branding ===
      `data:text/html,<html><body style='margin:0;background:#111;color:#ddd;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;'>Starting ${APP_DISPLAY_NAME}...</body></html>`,
      // === CUSTOM FORK END ===
    );
  } else {
