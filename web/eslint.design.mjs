...
export const designTokenIgnores = [
  ...
  // === CUSTOM FORK START: Fork Architecture ===
  // Fork extensions may use feature-local motion/spacing values without
  // extending the upstream token set (see .cursor/rules/fork-architecture.mdc).
  "src/custom/**",
  // === CUSTOM FORK END ===
